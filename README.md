# EcoScan
EcoScan – AI-powered waste sorting using a live camera scanner to identify everyday items and provide proper disposal guidance to reduce plastic pollution.
...
EcoScan combines real-time image capture with AI analysis to create a simple and effective tool for understanding the environmental impact of everyday objects.
